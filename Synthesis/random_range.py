...
if __name__ == '__main__':
    ...
    UList = readMatOptFile(params.infile,params.t)
    ...
    # i = 204
    # for p2 in paramList:
    #     random_run(UList,i,p2)
    with concurrent.futures.ProcessPoolExecutor(max_workers=None) as executor:
        myrange = range(len(UList))
        # myrange = [i]
        threadFuture = {executor.submit(random_run,UList,i,p2): (i+1) for p2 in paramList for i in myrange }
